...
❌ Delete tasks
🛡️ Form validation
💬 User-friendly validation modals
...
git clone https://github.com/Mohammadalijafari/ProjectManagement.git
...
Save the project.
Select a Project
Click a project from the sidebar to view its details.
The selected project displays its:
Title
Description
Due date
Tasks
Add a Task
Enter a task in the task input and add it to the selected project.
Delete a Task
